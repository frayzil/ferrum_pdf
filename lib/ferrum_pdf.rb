...
module FerrumPdf
  ...
  class << self
    ...
    def render_pdf(html: nil, url: nil, host: nil, protocol: nil, authorize: nil, wait_for_idle_options: nil, pdf_options: {}, browser_options: {})
      render(host: host, protocol: protocol, html: html, url: url, authorize: authorize, wait_for_idle_options: wait_for_idle_options, browser_options: browser_options) do |page|
    ...
    def render_screenshot(html: nil, url: nil, host: nil, protocol: nil, authorize: nil, screenshot_options: {}, browser_options: {})
      render(host: host, protocol: protocol, html: html, url: url, authorize: authorize, browser_options: browser_options) do |page|
        page.screenshot(**screenshot_options.with_defaults(encoding: :binary, full: true))
      end
    end

    def render(host:, protocol:, html: nil, url: nil, authorize: nil, wait_for_idle_options: nil, browser_options: {})
